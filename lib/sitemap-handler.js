  ...
  return new Promise(function (resolve, reject) {
    ...
    request.get(target).end(function(err, res) {
      if (err || !res.ok) {
        ...
        winston.info("begin processing for: " + response['site_name'], logOpts);
      ...
      return promise.then(function() {
        ...
        winston.info("processed: " + pageLinks.length + " pages for target: " + target, {module: colors.red("index.js")});
        resolve(bodybuffer);
      });
    }); //end request.get
  }); //end new Promise
